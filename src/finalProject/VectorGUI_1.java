...
public class VectorGUI_1 
{
	...
	public static Scene startVector(Stage primaryStage)
	{
...
//			 Vector3D.main(new String[0]);
		...
		addButton.setOnAction(e -> 
		{
			...
			vector3.add(v3y);
			vector3.add(v3z);
			Coord3d v1 = new Coord3d(Double.valueOf(box1.getText()), Double.valueOf(box2.getText()), Double.valueOf(box3.getText()));
			Coord3d v2 = new Coord3d(Double.valueOf(box4.getText()), Double.valueOf(box5.getText()), Double.valueOf(box6.getText()));
		...
		layout.getChildren().addAll(homeButton, box1, box2, box3, box4, box5, box6, output, addButton, subtractButton, multiplyButton, clearButton, bGui);
		
		return new Scene(layout, 500, 500);
	}

	private static AWTChart getDemoChart(JavaFXChartFactory factory, String toolkit, ArrayList<Coord3d> coord) 
    {
        // -------------------------------
